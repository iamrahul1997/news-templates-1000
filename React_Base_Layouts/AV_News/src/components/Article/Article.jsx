...
//   const trendingPosts = allPosts.filter((p) => p.slug !== slug).slice(3, 6);
//   const latestNewsPosts = allPosts.filter((p) => p.slug !== slug).slice(6, 12);
...
//             <span>Article</span>
//           </div>
//           <div className="article-category">{article.section || "General"}</div>
//           <h1 className="article-title">{article.title}</h1>
//           <div className="article-meta">
//             <div className="article-date">{formatDate(article.createdAt)}</div>
//             <div className="article-stats">
//               <span>
//                 <i className="fas fa-eye"></i> {article.views || 0}
//               </span>
...
//                 <Link to={`/article/${article.prev.slug}`} className="nav-link">
//                   <div className="nav-content">
//                     <span className="nav-label">Previous Article</span>
//                     <h4>{article.prev.title}</h4>
//                   </div>
//                 </Link>
//               </div>
//             )}
...
//                 <Link to={`/article/${article.next.slug}`} className="nav-link">
//                   <div className="nav-content">
//                     <span className="nav-label">Next Article</span>
//                     <h4>{article.next.title}</h4>
//                   </div>
//                 </Link>
//               </div>
//             )}
...
//                 <div className="trending-item" key={post.slug}>
//                   <Link to={`/article/${post.slug}`} className="trending-link">
//                     <div
